...
import com.example.rebazaar.databinding.ActivityLoginPhoneBinding
    ...
    private fun phoneLoginCallBacks(){
        ...
        mCallbacks = object : OnVerificationStateChangedCallbacks(){
            ...
            override fun onCodeSent(verificationId: String, token: ForceResendingToken) {
                ...
                //the SMS verification code has been sent to the provided phone number , now we need to ask the use to enter the code and then construct a credential by combining the code with a verification ID.
